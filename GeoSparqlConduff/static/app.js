/* 
 * Configure jQuery to use Django's CRSF protection
 * 
 */
...
function init() {
    ...
    var smallScale = new OpenLayers.Layer.XYZ('SmallScale',
    ...
    var nationalMapWMS = new OpenLayers.Layer.XYZ('NationalMapLarge',
...
function submitquery() {
    ...
    var request = $.ajax({
        type: "GET",
        url: "http://usgs-ybother.srv.mst.edu/ontology/data/NationalMapData",
        data: {
            "query": $("#queryarea").val(),
            "output": "json"
        }
